...
Revision ID: 9ec1daf31e58
Revises: bd657bb5f35c
Create Date: 2024-05-18 21:47:53.172554
...
revision = '9ec1daf31e58'
down_revision = 'bd657bb5f35c'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id_institutie', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['id_institutie'], ['institutii.id'], name='pacienti_spitalul_clinic_județean_de_urgen_id_institutie_fkey'),
    ...
    sa.Column('adresa', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('id_institutie', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['id_institutie'], ['institutii.id'], name='pacienti_spitalul_clinic_cfr_id_institutie_fkey'),
    ...
    sa.Column('adresa', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('id_institutie', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['id_institutie'], ['institutii.id'], name='pacienti_arcadia_id_institutie_fkey'),
    ...
    sa.Column('adresa', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('id_institutie', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['id_institutie'], ['institutii.id'], name='pacienti_parhon_id_institutie_fkey'),
    ...
    sa.Column('adresa', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('id_institutie', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['id_institutie'], ['institutii.id'], name='pacienti_providența_id_institutie_fkey'),
    ...
    sa.Column('adresa', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('id_institutie', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['id_institutie'], ['institutii.id'], name='pacienti_spitalul_de_copii_sf_maria_id_institutie_fkey'),
