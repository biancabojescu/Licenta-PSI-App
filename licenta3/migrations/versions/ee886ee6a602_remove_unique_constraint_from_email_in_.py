"""Remove unique constraint from email in Pacienti

Revision ID: ee886ee6a602
Revises: e8e7318bbd76
Create Date: 2024-05-29 20:02:49.199888
...
revision = 'ee886ee6a602'
down_revision = 'e8e7318bbd76'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('pacienti', schema=None) as batch_op:
        batch_op.drop_constraint('pacienti_email_key', type_='unique')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('pacienti', schema=None) as batch_op:
        batch_op.create_unique_constraint('pacienti_email_key', ['email'])
